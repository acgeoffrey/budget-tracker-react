...
const paginationButton = `flex items-center justify-center gap-2 border-none bg-emerald-600 px-1
py-1 font-medium text-emerald-50 transition-all duration-300 [&>svg]:h-5 [&>svg]:w-5`;
  ...
  return (
    <div className='flex w-[100%] items-center justify-between'>
      <p className='ml-3 [&>span]:font-bold'>
        ...
        <span>
          {' '}
          {currentPage === totalPages ? count : currentPage * 10}
